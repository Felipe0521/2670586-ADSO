 ...
 * @author felip
 */
public class EditarMusica extends javax.swing.JPanel {

    ConsumoAPI consumo;
    /**
     * Creates new form EditarMusica
     */
    public EditarMusica(ConsumoAPI consumo) {
    ...
    private void btn_cactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cactualizarActionPerformed
        ...
        if( !nombres.equals("") && !apellidos.equals("") && !telefono.equals("") && !direccion.equals("")){
            Map<String, String> datosActualizar = new HashMap<>();
            datosActualizar.put("codigo_cancion", cedula);
            datosActualizar.put("nombre", nombres);
            datosActualizar.put("compositor", apellidos);
            datosActualizar.put("estreno", telefono);
            datosActualizar.put("genero", direccion);
            
            String respuesta3 = consumo.consumoPOST("http://localhost/02-APImusica/API/Actualizar_cancion.php", datosActualizar);
       ...
       int encontrado = -1;
        ...
        for (int i = 0; i < registros.size(); i++) {
            ...
            if(temp.get("codigo_cancion").getAsString().equals(cedula)){
                  encontrado = 1;
                 campoApellidos.setText(temp.get("compositor").getAsString());
                 campoNombre.setText(temp.get("nombre").getAsString());
                 campoTelefono.setText(temp.get("estreno").getAsString());
                 campoDireccion.setText(temp.get("genero").getAsString());
