...
public class Menu extends javax.swing.JFrame {
    ...
    public void initAltherComponents(){
        ...
        Image icono_registro = getToolkit().createImage(ClassLoader.getSystemResource("imagenes/musica.jpeg"));
        icono_registro = icono_registro.getScaledInstance(150, 150, Image.SCALE_SMOOTH);
        etqImagen.setIcon(new ImageIcon(icono_registro));
        setIconImage(getToolkit().createImage(ClassLoader.getSystemResource("imagenes/musica.jpeg")));
        
        
        btnListar.setBackground(Color.WHITE);
        Image icono_listar = getToolkit().createImage(ClassLoader.getSystemResource("imagenes/listar.png"));
        ...
        Image icono_crear = getToolkit().createImage(ClassLoader.getSystemResource("imagenes/agregar.png"));
        ...
        Image icono_editar = getToolkit().createImage(ClassLoader.getSystemResource("imagenes/modificar.png"));
    ...
    private void initComponents() {
        ...
        contentMenu.setBackground(new java.awt.Color(153, 153, 255));
        ...
        etqTemporal.setBackground(new java.awt.Color(153, 153, 255));
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
       Listar nuevo = new Listar(consumo);
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        CrearMusica nuevo = new CrearMusica(consumo);
          nuevo.setPreferredSize(contentPrincipal.getPreferredSize());
        nuevo.setSize(contentPrincipal.getSize());
        // eliminar contenido del cont principal //
        contentPrincipal.removeAll();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        EditarMusica nuevo = new EditarMusica(consumo);
        nuevo.setPreferredSize(contentPrincipal.getPreferredSize());
        nuevo.setSize(contentPrincipal.getSize());
        // eliminar contenido del cont principal //
        contentPrincipal.removeAll();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        EliminarCancion nuevo = new EliminarCancion(consumo);
         nuevo.setPreferredSize(contentPrincipal.getPreferredSize());
        nuevo.setSize(contentPrincipal.getSize());
        // eliminar contenido del cont principal //
        contentPrincipal.removeAll();
