...
public class PanelEliminar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese cedula de persona a eliminar.");
        ...
        tablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Documento", "Nombres", "Apellidos", "Telefono", "Direccion", "Correo"
            }
        ) {
    ...
    public  void imprimirPersonas(){
        ...
        for (int i = 0; i < lista.length && lista[i] != null; i++) {
              ...
              if(persona.getDocumento().equals(cedula)){
                  encontrado = 1;
                  Object[] data = {persona.getDocumento(), persona.getNombres(), persona.getApellidos(), persona.getTelefono(),persona.getDireccion(), persona.getCorreo()};
                modelo.addRow(data);
              }
