...
public class Facturador extends JFrame{
	...
	public void initComponent(){
		...
		*/
        ...
        Border borderColor = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.decode("#D4D456"));
		...
		input_cedula_cliente.addKeyListener( eventoKey );
		...
		input_cedula_vendedor.addKeyListener( eventoKey2 );
